...
set(dummy_filename "${CMAKE_CURRENT_BINARY_DIR}/mkldnn_dummy.c")
set(dummy_generator "${PROJECT_SOURCE_DIR}/cmake/external/mkldnn.cmake")
set(dummy_string "${dummy_filename}")
configure_file(${PROJECT_SOURCE_DIR}/cmake/dummy.c.in ${dummy_filename} @ONLY)

ADD_LIBRARY(mkldnn STATIC ${dummy_filename})
